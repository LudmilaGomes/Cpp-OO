...
void JogoVelha::realizaJogadas()
{
    ...
    while(contQualJogador < 9) // quando todas as casas forem preenchidas, ou seja, quando 'contQualJogador == 8' (pois 'contQualJogador' vai de 0 a 8)
    {
        ...
        {
            cout << "Você digitou valores inválidos para a linha ou coluna. Digite novamente.\n";
        ...
        {
            cout << "Você digitou uma posição que já foi escolhida anteriormente." << endl;
            do
            {
                cout << "Digite, respectivamente, a linha e coluna:" << endl;
                cout << " >>> ";
        ...
        if(checaVencedor() == 1)
        {
            cout << "O jogador 1 venceu esta partida! Parabéns!\n";
            break;

        }
        if(checaVencedor() == -1)
        {
            cout << "O jogador 2 venceu esta partida! Parabéns!\n";
            break;
        }
        if(contQualJogador == 8)
        {
            ...
            if(checaVencedor() == 0)
                cout << "Ninguém venceu a partida! Empate!\n";
        }
...
void JogoVelha::realizaJogadasComputador()
{
    while(contQualJogador < 9) // quando todas as casas forem preenchidas, ou seja, quando 'contQualJogador == 8' (pois 'contQualJogador' vai de 0 a 8)
    {
        ...
        if(checaVencedor() == -1)
        {
            cout << "O computador venceu esta partida! Parabéns, senhora máquina!\n";
            break;
        }
        if(contQualJogador == 8)
        {
